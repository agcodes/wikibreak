...
<template>
  <div>
    <h2 class="mb-4 fs130">Trouvez l'article</h2>
    ...
    <div class="mb-4" v-if="randomArticle">
      <div>
        <div v-if="guessLoaded">
          <div
            v-if="mode == 'anagram' || mode == 'anagram-2'"
            class="card mb-4"
          >
        ...
        <div class="mb-4">
          <div v-if="guessLoaded" class="mb-4">
  ...
  setup() {
    ...
    const initGuess = () => {
      ...
      if (scores.value.length == 0) {
        ...
        feedback.value = `Round ${
          scores.value.length + 1
        }. Choisir un article parmi les propositions`;
      }
    };
